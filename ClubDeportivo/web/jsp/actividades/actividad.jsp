                                ...
                                <div class="col-lg-8 offset-lg-2" style="margin-top: 2%">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Agregar nueva Actividad</h6>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <form action="Actividades" method="post" class="user needs-validation" novalidate>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="invalid-feedback">Debe ingresar un costo y no puede ser mayor a 10000 ni menor a 0</div>
                                                </div>

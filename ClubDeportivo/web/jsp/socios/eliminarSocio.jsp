                    ...
                    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid" style="margin-top: 2%">
                                ...
                                <!-- Page Heading -->
                                <h1 class="h3 mb-2 text-gray-800">Socios</h1>
                                <div class="col-lg-8 offset-lg-2" style="margin-top: 2%">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Eliminar Socio</h6>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-4">¿Esta seguro que desea eliminar el siguiente Socio?</p>
                                            <form action="Socios" method="post" class="user">
                                                <input type="hidden" name="idSocio" 
                                                       value="<jsp:getProperty name="modeloSocio" property="id"></jsp:getProperty>" />
                                                <input type="hidden" name="eliminar" value="true">
                                                <p>Nº de socio: ${modeloSocio.id}</p>
                                                <p>Nombre y Apellido: ${modeloSocio.getNombreCompleto()}</p>
                                                <p>DNI: ${modeloSocio.dni}</p>

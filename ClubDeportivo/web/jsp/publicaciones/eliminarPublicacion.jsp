                                ...
                                <div class="col-lg-8 offset-lg-2" style="margin-top: 2%">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Eliminar Publicacion</h6>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-4">¿Esta seguro que desea eliminar la siguiente publicacion?</p>
                                            <form action="Publicaciones" method="post" class="user">
                                                <input type="hidden" name="idPublicacion" 
                                                       value="<jsp:getProperty name="modeloPublicacion" property="id"></jsp:getProperty>" />
                                                <input type="hidden" name="eliminar" value="true">   
                                                <p>Titulo: ${modeloPublicacion.titulo}</p>
                                                <p>Contenido:  ${modeloPublicacion.contenido}</p>
